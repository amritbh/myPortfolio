...
test('renders Podcast without crashing', () => {
  render(
    <BrowserRouter>
      <Podcast theme={{ text: 'black', body: 'white', compImgHighlight: 'white', highlight: 'white', secondaryText: 'gray', imageHighlight: 'white' }} />
    </BrowserRouter>
  );
});
