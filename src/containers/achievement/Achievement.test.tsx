...
test('renders Achievement without crashing', () => {
  const { container } = render(
    <BrowserRouter>
      <Achievement theme={{ text: 'black', body: 'white', compImgHighlight: 'white', highlight: 'white', secondaryText: 'gray', imageHighlight: 'white' }} />
    </BrowserRouter>
  );
