...
describe("AdminDashboard Component", () => {
  beforeEach(() => {
    ...
    vi.spyOn(apiClient, "getStoredToken").mockReturnValue("token");
    jest
      .spyOn(apiClient, "getStoredUser")
      .mockReturnValue({ role: "admin", username: "adminuser" });
    vi.spyOn(apiClient, "fetchBlogs").mockResolvedValue(mockBlogs);
  });
  ...
  it("renders unified dashboard and handles new blog creation", async () => {
    vi.spyOn(apiClient, "createBlog").mockResolvedValue({ success: true });
  ...
  it("handles edit flow from My Stories sidebar", async () => {
    vi.spyOn(apiClient, "updateBlog").mockResolvedValue({ success: true });
  ...
  it("handles delete flow from My Stories sidebar", async () => {
    vi.spyOn(apiClient, "deleteBlog").mockResolvedValue({ success: true });
