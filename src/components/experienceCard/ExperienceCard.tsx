        ...
        <Fade left duration={2000} distance="40px">
          <div className="experience-card-logo-div">
            <img
              ...
              src={new URL(`../../assests/images/${experience["logo_path"] || "projects_image.svg"}`, import.meta.url).href}
              alt={experience["company"]}
              onError={(e) => {
                (e.target as HTMLImageElement).src = new URL(`../../assests/images/projects_image.svg`, import.meta.url).href;
              }}
            />
          </div>
        </Fade>
